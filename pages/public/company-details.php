...
<div class="container py-5">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h1 class="h3 fw-bold mb-2 section-heading">
                ...
                <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                    ...
                    <?php endif; ?>
                    <a href="<?= Config::BASE_URL ?>/pages/public/jobs.php?company=<?= $companyId ?>" class="btn btn-dark" style="
                        border-radius: 8px;
                        padding: 0.6rem 1.2rem;
                        font-weight: 500;
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 16px;">
                <div class="card-body p-4">
                    <h2 class="h5 fw-bold mb-4 section-heading">About <?= htmlspecialchars($companyData['companyName']) ?></h2>
                    
                    <div class="description mb-4 about-company-description">
                    ...
                    <div class="mt-5">
                        <h3 class="h5 fw-bold mb-4 section-heading">Open Positions</h3>
                        <div class="list-group">
                            <?php foreach ($companyJobs['jobs'] as $job): ?>
                            <a href="/pages/public/job-details.php?id=<?= $job['jobId'] ?>" 
                               class="list-group-item list-group-item-action border-0 mb-2 job-list-item"
                               onmouseover="this.style.backgroundColor='#f1f5f9'"
                               onmouseout="this.style.backgroundColor='#f8fafc'">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    <h5 class="mb-1 job-title"><?= htmlspecialchars($job['jobTitle']) ?></h5>
                                    <?php if (!empty($job['location'])): ?>
                                    <span class="badge bg-light text-dark job-location-badge"><?= htmlspecialchars($job['location']) ?></span>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="<?= Config::BASE_URL ?>/pages/public/jobs.php?company=<?= $companyId ?>" class="btn btn-outline-primary btn-sm" style="
                                border-radius: 8px;
                                padding: 0.5rem 1rem;
                                font-weight: 500;
                            ">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 16px;">
                <div class="card-body p-4">
                    <h3 class="h6 fw-bold mb-4 section-heading">Company Information</h3>
                    
                    <ul class="list-unstyled">
                        <?php if (!empty($companyData['industry'])): ?>
                        <li class="d-flex mb-4">
                            <i class="bi bi-building me-3 company-info-icon"></i>
                            <div>
                                <span class="company-info-label">Industry</span>
                                <span class="company-info-value"><?= htmlspecialchars($companyData['industry']) ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="d-flex mb-4">
                            <i class="bi bi-people me-3 company-info-icon"></i>
                            <div>
                                <span class="company-info-label">Company Size</span>
                                <span class="company-info-value"><?= htmlspecialchars($companyData['employeeCount']) ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="d-flex mb-4">
                            <i class="bi bi-calendar-event me-3 company-info-icon"></i>
                            <div>
                                <span class="company-info-label">Founded</span>
                                <span class="company-info-value"><?= htmlspecialchars($companyData['foundedYear']) ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <?php if (!empty($companyData['headquarters'])): ?>
                        <li class="d-flex mb-4">
                            <i class="bi bi-geo-alt me-3 company-info-icon"></i>
                            <div>
                                <span class="company-info-label">Location</span>
                                <span class="company-info-value"><?= htmlspecialchars($companyData['headquarters']) ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <?php if (!empty($companyData['websiteUrl'])): ?>
                        <li class="d-flex">
                            <i class="bi bi-globe me-3 company-info-icon"></i>
                            <div>
                                <span class="company-info-label">Website</span>
                                <a href="<?= htmlspecialchars($companyData['websiteUrl']) ?>" target="_blank" class="company-website-link">
            ...
            <div class="card shadow-sm border-0" style="border-radius: 16px;">
                <div class="card-body p-4">
                    <h3 class="h6 fw-bold mb-4 section-heading">Similar Companies</h3>
                    
                    <div class="d-flex flex-column gap-3">
                        <?php if (!empty($companyData['industry'])): ?>
                        <p class="small text-muted mb-2">Explore more companies in <?= htmlspecialchars($companyData['industry']) ?></p>
                        <a href="/pages/public/companies.php?industry=<?= urlencode($companyData['industry']) ?>" class="btn btn-outline-dark btn-sm" style="
                            border-radius: 8px;
                            padding: 0.5rem 1rem;
                            font-weight: 500;
                            border-width: 1.5px;
                        ...
                        <a href="/pages/public/companies.php" class="btn btn-outline-dark btn-sm" style="
                            border-radius: 8px;
                            padding: 0.5rem 1rem;
                            font-weight: 500;
                            border-width: 1.5px;
