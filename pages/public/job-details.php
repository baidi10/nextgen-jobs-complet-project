          ...
          <?php endif; ?>
            ...
            <div class="d-flex flex-wrap gap-3 mt-3">
              ...
              <div class="d-flex align-items-center">
                ...
                Posted <?= date('M j', strtotime($jobDetails['createdAt'])) ?>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="sticky-top" style="top: 100px;">
        ...
        <div class="bg-white p-4 rounded border shadow-sm mb-4">
          ...
          <div class="d-flex gap-2 flex-wrap mt-4">
            ...
            <a href="<?= Config::BASE_URL ?>/pages/public/companies.php?id=<?= $jobDetails['companyId'] ?>" 
        ...
        <div class="bg-white p-4 rounded border shadow-sm">
          ...
          <div class="similar-jobs">
            ...
            <a href="<?= Config::BASE_URL ?>/pages/public/jobs.php" class="btn btn-sm btn-outline-dark rounded-pill px-3">
