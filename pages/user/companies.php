    ...
    <div class="col-lg-9">
          ...
          <div class="d-flex flex-wrap gap-2">
            <?php if (!empty($searchQuery)): ?>
              <span class="badge bg-primary rounded-pill px-3 py-2">
                ...
                <a href="<?= Config::BASE_URL ?>/pages/user/companies.php<?= !empty($industryFilter) ? '?industry=' . urlencode($industryFilter) : '' ?>" class="text-white ms-2 text-decoration-none">
            ...
            <?php if (!empty($industryFilter)): ?>
              <span class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2">
                ...
                <a href="<?= Config::BASE_URL ?>/pages/user/companies.php<?= !empty($searchQuery) ? '?q=' . urlencode($searchQuery) : '' ?>" class="text-primary ms-2 text-decoration-none">
                  <i class="bi bi-x-circle"></i>
                </a>
              </span>
            <?php endif; ?>
            
            <a href="<?= Config::BASE_URL ?>/pages/user/companies.php" class="btn btn-sm btn-link text-decoration-none">Clear all</a>
          </div>
        </div>
      </div>
      <?php endif; ?>
                  ...
                  <div class="d-flex align-items-start" style="gap: 30px;">
                    ...
                    <div class="flex-grow-1">
                      <h2 class="h6 fw-bold mb-0">
                        <a href="<?= Config::BASE_URL ?>/pages/user/company-details.php?id=<?= $companyItem['companyId'] ?>" 
          ...
          <div class="col-12">
            <div class="card border-0">
              <div class="card-body text-center py-5">
                ...
                <a href="<?= Config::BASE_URL ?>/pages/user/companies.php" class="btn btn-outline-primary rounded-pill px-4">Clear all filters</a>
              </div>
            </div>
          </div>
        <?php endif; ?>
      ...
      <?php if ($result['pages'] > 1): ?>
        <nav class="mt-5">
          ...
          $fullBaseUrl = Config::BASE_URL . '/pages/user/companies.php';
