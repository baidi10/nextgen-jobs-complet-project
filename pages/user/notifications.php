...
if (!isLoggedIn() || !isJobSeeker()) {
    $_SESSION['error_message'] = 'You must be logged in as a job seeker to access this page.';
...
try {
    $query = "SELECT n.*, 
                     CASE 
                         WHEN n.notificationType = 'application_status' THEN 'bi-briefcase'
                         WHEN n.notificationType = 'message' THEN 'bi-chat'
                         WHEN n.notificationType = 'system' THEN 'bi-gear'
                         WHEN n.notificationType = 'job_alert' THEN 'bi-bell'
